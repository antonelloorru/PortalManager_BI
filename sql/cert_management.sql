...
-- NOTA MULTI-ISTANZA: Le istruzioni CREATE DATABASE e USE sono state rimosse
-- per consentire il restore / importazione diretta in qualsiasi schema MySQL selezionato.
-- CREATE DATABASE IF NOT EXISTS `cert_management` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE `cert_management`;
...
--
-- Struttura della tabella `menu_preferences`
--
