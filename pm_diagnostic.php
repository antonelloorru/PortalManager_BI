...
/**
 * PortalManager v1.9.34 — Pagina diagnostica (ROOT del portale).
 *
 * IMPORTANTE: questo file DEVE stare nella ROOT del gestionale
 *   P:\xampp\htdocs\portalmanager\pm_diagnostic.php
 * NON in tools/. Le pagine in sottocartelle rompono i link relativi del menu
 * generati da header.php (r.php?r=<slug> viene risolto dal browser come
 * tools/r.php e produce 404).
 *
 * Accesso diretto senza router, come le altre pagine api del gestionale:
 *   https://<host>/portalmanager/pm_diagnostic.php
 */
...
echo '<h2>File PHP nel gestionale con "servizi"/"relazion"/"dgb"/"report"/"desk"/"it_"</h2><ul>';
