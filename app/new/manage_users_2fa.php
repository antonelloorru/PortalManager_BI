...
<div class="filter-tabs">
  <a href="?filter=all" class="<?= $filter === 'all' ? 'active' : '' ?>">Tutti (<?= $total ?>)</a>
  <a href="?filter=enabled" class="<?= $filter === 'enabled' ? 'active' : '' ?>">Con 2FA (<?= $enabled ?>)</a>
  <a href="?filter=disabled" class="<?= $filter === 'disabled' ? 'active' : '' ?>">Senza 2FA (<?= $total - $enabled ?>)</a>
</div>
