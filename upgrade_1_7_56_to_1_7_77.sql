...
INSERT INTO `app_settings` (`setting_key`,`setting_value`,`description`) VALUES ('app_version','1.7.77','Versione applicazione'),('schema_version','1.7.77','Versione schema database'),('release_label','1.7.77','Etichetta release mostrata in footer'),('proj_annual_hours','1720','Ore/uomo annue per costo orario commesse'),('proj_oneri_mult','1.42','Moltiplicatore oneri aziendali su RAL') ON DUPLICATE KEY UPDATE setting_value=VALUES(setting_value);
