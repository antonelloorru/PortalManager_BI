# Manuale Amministratore — v1.7.90 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.90)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.90)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.90)
...
## Professionisti esterni nel team di commessa (v1.7.90)
...
## Mappare un tecnico non risolto a un professionista (v1.7.90)
...
## Fasce legate alla singola commessa (v1.7.90)
...
## Estrazione Anagrafica Dipendenti (v1.7.90)
Menu *Anagrafica → Estrazione anagrafica*. Consente di scaricare in **XLSX** o **CSV** i dati
anagrafico-contrattuali dei dipendenti: Cognome, Nome, Codice fiscale, Matricola, Contratto, Data
