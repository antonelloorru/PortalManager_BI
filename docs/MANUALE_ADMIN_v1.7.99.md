# Manuale Amministratore — v1.7.99 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.99)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.99)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.99)
...
## Professionisti esterni nel team di commessa (v1.7.99)
...
## Mappare un tecnico non risolto a un professionista (v1.7.99)
...
## Fasce legate alla singola commessa (v1.7.99)
...
## Estrazione Anagrafica Dipendenti (v1.7.99)
...
## Verifica & Merge: controllo "Email aziendale mancante" (v1.7.99)
...
## Compensation & Benefit: costo pieno e valore FTE (v1.7.99)
...
## Valori di riferimento HR e scheda Compensation (v1.7.99)
...
## Formule di calcolo modificabili (v1.7.99)
...
## Tipo di rapporto "Interinale" (v1.7.99)
...
## Finance: personalizzare la vista (v1.7.99)
