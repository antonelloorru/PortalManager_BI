# PortalManager — Guida al Deployment v1.8.1
## Aggiornamento a v1.8.1
Da **v1.8.0** già applicata: eseguire solo `sql/migration_v1_8_1.sql`.
Da **v1.7.99** o precedenti: eseguire `sql/migration_v1_8_0.sql` e poi `sql/migration_v1_8_1.sql`, oppure il consolidato `upgrade_1_7_56_to_1_8_1.sql`.
...
### 1. Contenuto del pacchetto `PortalManager_v1.8.1.zip`
```
app/CostModel.php                 (modificato — calcolo anno-aware)
app/MenuManager.php               (modificato — voci menu)
app/Version.php                   (modificato — PM_VERSION 1.8.1)
...
upgrade_1_7_56_to_1_8_1.sql       (consolidato root per system_update)
VERSION                           (1.8.1)
CHANGELOG.md
...
Expand-Archive -Path .\PortalManager_v1.8.1.zip -DestinationPath P:\xampp\htdocs\portalmanager -Force
```
...
- Footer/Impostazioni: versione **1.8.1**.
