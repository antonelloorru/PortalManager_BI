# Manuale Amministratore — v1.7.94 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.94)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.94)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.94)
...
## Professionisti esterni nel team di commessa (v1.7.94)
...
## Mappare un tecnico non risolto a un professionista (v1.7.94)
...
## Fasce legate alla singola commessa (v1.7.94)
...
## Estrazione Anagrafica Dipendenti (v1.7.94)
...
## Verifica & Merge: controllo "Email aziendale mancante" (v1.7.94)
...
## Compensation & Benefit: costo pieno e valore FTE (v1.7.94)
...
## Valori di riferimento HR e scheda Compensation (v1.7.94)
