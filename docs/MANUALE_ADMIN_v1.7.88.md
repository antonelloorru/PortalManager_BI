# Manuale Amministratore — v1.7.88 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.88)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.88)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.88)
...
## Professionisti esterni nel team di commessa (v1.7.88)
...
## Mappare un tecnico non risolto a un professionista (v1.7.88)
