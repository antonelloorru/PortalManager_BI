# PortalManager — Guida al Deployment v1.8.2
## Aggiornamento a v1.8.2
Da **v1.8.1** già applicata: eseguire solo `sql/migration_v1_8_2.sql` (solo allineamento versione; la feature è applicativa).
Da **v1.8.0**: eseguire `sql/migration_v1_8_1.sql` e `sql/migration_v1_8_2.sql`.
Da **v1.7.99** o precedenti: eseguire in ordine `migration_v1_8_0.sql`, `migration_v1_8_1.sql`, `migration_v1_8_2.sql`, oppure il consolidato `upgrade_1_7_56_to_1_8_2.sql`.
...
### 1. Contenuto del pacchetto `PortalManager_v1.8.2.zip`
```
app/CostModel.php                 (modificato — calcolo anno-aware)
app/MenuManager.php               (modificato — voci menu)
app/Version.php                   (modificato — PM_VERSION 1.8.2)
...
upgrade_1_7_56_to_1_8_2.sql       (consolidato root per system_update)
VERSION                           (1.8.2)
CHANGELOG.md
...
Expand-Archive -Path .\PortalManager_v1.8.2.zip -DestinationPath P:\xampp\htdocs\portalmanager -Force
```
...
- Footer/Impostazioni: versione **1.8.2**.
