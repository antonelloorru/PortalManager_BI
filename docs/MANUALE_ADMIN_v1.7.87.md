# Manuale Amministratore — v1.7.87 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.87)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.87)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.87)
...
## Professionisti esterni nel team di commessa (v1.7.87)
