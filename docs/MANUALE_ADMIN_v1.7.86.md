# Manuale Amministratore — v1.7.86 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.86)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.86)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.86)
