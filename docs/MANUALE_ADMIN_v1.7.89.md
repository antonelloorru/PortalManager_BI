# Manuale Amministratore — v1.7.89 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.89)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.89)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.89)
...
## Professionisti esterni nel team di commessa (v1.7.89)
...
## Mappare un tecnico non risolto a un professionista (v1.7.89)
...
## Fasce legate alla singola commessa (v1.7.89)
