# Manuale Amministratore — v1.7.93 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.93)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.93)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.93)
...
## Professionisti esterni nel team di commessa (v1.7.93)
...
## Mappare un tecnico non risolto a un professionista (v1.7.93)
...
## Fasce legate alla singola commessa (v1.7.93)
...
## Estrazione Anagrafica Dipendenti (v1.7.93)
...
## Verifica & Merge: controllo "Email aziendale mancante" (v1.7.93)
...
## Compensation & Benefit: costo pieno e valore FTE (v1.7.93)
