# Manuale Amministratore — v1.7.96 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.96)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.96)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.96)
...
## Professionisti esterni nel team di commessa (v1.7.96)
...
## Mappare un tecnico non risolto a un professionista (v1.7.96)
...
## Fasce legate alla singola commessa (v1.7.96)
...
## Estrazione Anagrafica Dipendenti (v1.7.96)
...
## Verifica & Merge: controllo "Email aziendale mancante" (v1.7.96)
...
## Compensation & Benefit: costo pieno e valore FTE (v1.7.96)
...
## Valori di riferimento HR e scheda Compensation (v1.7.96)
...
## Formule di calcolo modificabili (v1.7.96)
...
## Tipo di rapporto "Interinale" (v1.7.96)
