# PortalManager — Manuale Amministratore v1.8.0
## Dati economici per anno di competenza

Destinatari: Amministratore, HR Director, Responsabile Finanziario.
...
Alla prima installazione della v1.8.0 tutti i dati economici esistenti vengono
...
Responsabile Finanziario. La matrice è modificabile in *Amministrazione → Permessi
