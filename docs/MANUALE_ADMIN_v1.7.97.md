# Manuale Amministratore — v1.7.97 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.97)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.97)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.97)
...
## Professionisti esterni nel team di commessa (v1.7.97)
...
## Mappare un tecnico non risolto a un professionista (v1.7.97)
...
## Fasce legate alla singola commessa (v1.7.97)
...
## Estrazione Anagrafica Dipendenti (v1.7.97)
...
## Verifica & Merge: controllo "Email aziendale mancante" (v1.7.97)
...
## Compensation & Benefit: costo pieno e valore FTE (v1.7.97)
...
## Valori di riferimento HR e scheda Compensation (v1.7.97)
...
## Formule di calcolo modificabili (v1.7.97)
...
## Tipo di rapporto "Interinale" (v1.7.97)
