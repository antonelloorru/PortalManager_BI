# Manuale Amministratore — v1.7.92 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.92)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.92)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.92)
...
## Professionisti esterni nel team di commessa (v1.7.92)
...
## Mappare un tecnico non risolto a un professionista (v1.7.92)
...
## Fasce legate alla singola commessa (v1.7.92)
...
## Estrazione Anagrafica Dipendenti (v1.7.92)
...
## Verifica & Merge: controllo "Email aziendale mancante" (v1.7.92)
