# Manuale Amministratore — v1.7.84 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.84)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.84)
