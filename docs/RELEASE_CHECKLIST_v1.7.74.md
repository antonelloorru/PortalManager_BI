# Release Checklist — v1.7.74 (Zero-omission)
...
- [x] Root con **un solo** SQL: `upgrade_1_7_56_to_1_7_74.sql` (40 statement, 0 skip indesiderati)
- [x] Consolidamento 1.7.56 → 1.7.74 idempotente; testato da 1.7.56 e da 1.7.59 pre-fix
...
## Documentazione
- [x] `docs/TECHNICAL_DESIGN_v1.7.74.md` (viste, logiche calcolo, moduli, schema ER)
- [x] `docs/MANUALE_ADMIN_v1.7.74.md`
- [x] `docs/MANUALE_UTENTE_v1.7.74.md`
- [x] `docs/DEPLOYMENT_v1.7.74.md`
