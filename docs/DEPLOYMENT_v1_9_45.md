# Deployment — PortalManager v1.9.45

1. File: `it_service.php` (root); `app/ItServiceModel.php`, `app/it_service_print.php`,
   `app/DocxWriter.php` (cartella `app/`).
2. SQL: `sql/migration_v1_9_45.sql` (solo versione). Da versione incerta:
   `sql/upgrade_to_1_9_45.sql`.

Via system_console.php: Aggiornamento (ZIP) → `PortalManager_v1_9_45.zip` → Analizza → Applica.
