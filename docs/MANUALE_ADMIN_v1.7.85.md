# Manuale Amministratore — v1.7.85 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.85)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.85)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.85)
