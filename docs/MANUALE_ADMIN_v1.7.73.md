# Manuale Amministratore — v1.7.73 (Gestione Commesse)
...
- **Sovrapposizioni tra commesse**: coppie di commesse che nello stesso periodo usano le stesse persone,
  con numero di risorse condivise, mesi e ore in contesa — utile per capire dove le pianificazioni
  competono per le stesse persone.
