# Manuale Amministratore — v1.7.91 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.91)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.91)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.91)
...
## Professionisti esterni nel team di commessa (v1.7.91)
...
## Mappare un tecnico non risolto a un professionista (v1.7.91)
...
## Fasce legate alla singola commessa (v1.7.91)
...
## Estrazione Anagrafica Dipendenti (v1.7.91)
