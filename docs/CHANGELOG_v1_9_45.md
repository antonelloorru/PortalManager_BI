# Release Notes — PortalManager v1.9.45

Data: 2026-09-08
Allineamento versioni: Software 1.9.45 · Schema 1.9.45 · Upgrade 1.9.45
...
sql/migration_v1_9_45.sql               allineamento versione (nessun delta schema)
sql/upgrade_to_1_9_45.sql        consolidato all'ultima release -> 1.9.45
...
- SQL migration/consolidato: RUN1/RUN2 err=0; `;` nei commenti = 0; versioni → 1.9.45.
