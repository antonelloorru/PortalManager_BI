# Manuale Amministratore — v1.7.95 (Gestione Commesse)
...
## Riconciliazione con Professionisti e importazione in Dipendenti (v1.7.95)
...
## Merge anagrafiche: criterio "Stesso nome (simile)" (v1.7.95)
...
## Controllo & Riconciliazione: verifica anagrafiche (v1.7.95)
...
## Professionisti esterni nel team di commessa (v1.7.95)
...
## Mappare un tecnico non risolto a un professionista (v1.7.95)
...
## Fasce legate alla singola commessa (v1.7.95)
...
## Estrazione Anagrafica Dipendenti (v1.7.95)
...
## Verifica & Merge: controllo "Email aziendale mancante" (v1.7.95)
...
## Compensation & Benefit: costo pieno e valore FTE (v1.7.95)
...
## Valori di riferimento HR e scheda Compensation (v1.7.95)
...
## Formule di calcolo modificabili (v1.7.95)
